...
public class Stringbuilder {
    ...
    System.out.println("Substring from index 3: " + sub1); // XWolleH

    
    String sub2 = sb.substring(3, 7);
    System.out.println("Substring from index 3 to 7: " + sub2); // XWol

    
    sb.setLength(5);
    System.out.println("After setLength(5): " + sb); // dlrXW
